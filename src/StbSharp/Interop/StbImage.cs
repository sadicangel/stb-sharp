...
internal unsafe partial struct stbi_io_callbacks
{
    ...
    [NativeTypeName("int (*)(void *)")] public delegate* unmanaged[Cdecl]<void*, int> eof;

    public stbi_io_callbacks(delegate* unmanaged[Cdecl]<void*, byte*, int, int> read, delegate* unmanaged[Cdecl]<void*, int, void> skip, delegate* unmanaged[Cdecl]<void*, int> eof)
    {
        this.read = read;
        this.skip = skip;
        this.eof = eof;
